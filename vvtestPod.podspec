Pod::Spec.new do |s|
s.name         = "vvtestPod"    #存储库名称
s.version      = "0.0.1"      #版本号，与tag值一致
s.summary      = "a repository demo"  #简介
s.description  = "a repository demo"  #描述
s.homepage     = "https://github.com/windoor/vvtestPod"      #项目主页，不是git地址
s.license      = { :type => "MIT", :file => "LICENSE" }   #开源协议
s.author             = { "nbl" => "438172@qq.com" }  #作者
s.platform     = :ios, "7.0"                  #支持的平台和版本号
s.source       = { :git => "https://github.com/windoor/vvtestPod.git", :tag => "0.0.1" }         #存储库的git地址，以及tag值
